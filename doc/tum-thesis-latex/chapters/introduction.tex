...
Sometimes we want to have a bit more of information regarding intermediate states, that is why small-step semantics exists.
...
We are left then with the program $y:=z$, after executing this final statement the value of $y$ changes to $5$, $x$ and $z$ remain unchanged.
