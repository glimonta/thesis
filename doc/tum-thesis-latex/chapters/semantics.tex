...
In the \verb|Seq| case we need to make a further case distinction on the first command of the sequential composition in order to differentiate the cases where it is SKIP and when it is not.
...
\begin{comment}
text ‹This is how we take a single step in an execution.
