...
definition "no_args_callfun_exec \<equiv> execute_show [] p"

definition "no_args_callfun_ex \<equiv> (
  shows_prog p ''''
)"

definition "no_args_callfun_test \<equiv> do {
...
setup \<open>export_c_code @{code no_args_callfun_ex} @{code no_args_callfun_exec} "../TestC" "no_args_callfun"\<close>
