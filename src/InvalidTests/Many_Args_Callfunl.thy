...
definition "many_args_callfunl_exec \<equiv> execute_show [] p"

definition "many_args_callfunl_ex \<equiv> (
  shows_prog p ''''
)"

definition "many_args_callfunl_test \<equiv> do {
...
setup \<open>export_c_code @{code many_args_callfunl_ex} @{code many_args_callfunl_exec} "../TestC" "many_args_callfunl"\<close>
